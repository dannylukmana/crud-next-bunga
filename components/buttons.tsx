...
import { deleteFlower } from "@/lib/actions";

export const CreateButton = () => { 
  return (
    <Link href="/flowers/create" className="inline-flex items-center space-x-1 text
...
export const DeleteButton = ({id}: {id:string}) => { 
  const DeleteFlowerWithId = deleteFlower.bind(null, id);
  return (
    <form action={DeleteFlowerWithId}>
